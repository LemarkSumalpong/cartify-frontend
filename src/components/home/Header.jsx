  ...
  return (
    <header className='relative py-5 h-[500px] flex items-center justify-center '>
        ...
        <div className='relative z-10 px-4 lg:px-4 py-5 -mt-20 md:-mt-16 lg:-mt-20'>
            ...
            <p className='text-base  md:text-lg lg:text-xl  font-normal text-black mb-4'>Discover the Latest Trend</p>
            <a href="#shop"className='text-black text-lg md:text-xl lg:text-2xl rounded-full bg-white px-3 py-2 shadow-md'>Shop Now</a>
            </div>
        </div>
